...
const OrderCancelModal = (props) => {
  ...
  const handleFinally = useCallback(async (isSuccess = false) => {
    if (onClose) {
      onClose(isSuccess);
    }
  });
          ...
          <VStack spacing={'1.5rem'}>
            ...
            <Box w={'100%'}>
              <Text
                ...
                lineHeight={'2.25rem'}
              >
                {localeText(LANGUAGES.MY_PAGE.ORDER.REASONS_FOR_CANCELLATION)}
              </Text>
            </Box>
            ...
            <Box w={'100%'}>
              <VStack spacing={'0.75rem'}>
                <Button
                  ...
                  bg={cancelIndex === 1 ? '#73829D' : null}
                  border={`1px solid ${cancelIndex === 1 ? '#73829D' : '#7895B2'}`}
                >
                  <Text
                    color={cancelIndex === 1 ? '#FFF' : '#556A7E'}
                    fontSize={'1rem'}
                    fontWeight={400}
                    lineHeight={'1.75rem'}
                  >
                ...
                <Button
                  ...
                  h={'3rem'}
                  w={'100%'}
                  bg={cancelIndex === 2 ? '#73829D' : null}
                  border={`1px solid ${cancelIndex === 2 ? '#73829D' : '#7895B2'}`}
                >
                  <Text
                    color={cancelIndex === 2 ? '#FFF' : '#556A7E'}
                    fontSize={'1rem'}
                    fontWeight={400}
                    lineHeight={'1.75rem'}
                  >
                ...
                <Button
                  ...
                  h={'3rem'}
                  w={'100%'}
                  bg={cancelIndex === 3 ? '#73829D' : null}
                  border={`1px solid ${cancelIndex === 3 ? '#73829D' : '#7895B2'}`}
                >
                  <Text
                    color={cancelIndex === 3 ? '#FFF' : '#556A7E'}
                    fontSize={'1rem'}
                    fontWeight={400}
                    lineHeight={'1.75rem'}
                  >
                ...
                <Button
                  ...
                  h={'3rem'}
                  w={'100%'}
                  bg={cancelIndex === 4 ? '#73829D' : null}
                  border={`1px solid ${cancelIndex === 4 ? '#73829D' : '#7895B2'}`}
                >
                  <Text
                    color={cancelIndex === 4 ? '#FFF' : '#556A7E'}
                    fontSize={'1rem'}
                    fontWeight={400}
                    lineHeight={'1.75rem'}
                  >
                    ...
                    <Box w={'100%'}>
                      <HStack justifyContent={'space-between'} spacing={'2rem'}>
                        <Box>
                          ...
                          >
                            {localeText(
                              LANGUAGES.MY_PAGE.ORDER.REFUND_SHIPPING_COST,
                            )}
                          </Text>
                        </Box>
                        <Box>
            ...
            <Box w={'100%'} h={'3rem'} mb={'1.25rem'}>
              ...
              >
                <Text
                  ...
                  lineHeight={'2.25rem'}
                >
                  {localeText(LANGUAGES.MY_PAGE.ORDER.REQUEST_CANCELLATION)}
                </Text>
              </Button>
            </Box>
          </VStack>
              ...
              <VStack spacing={0} px={'2.5rem'}>
                <Box w={'100%'}>
                  ...
                  <VStack spacing={'3.75rem'}>
                    {orderCardRow()}
                    <Box w={'100%'}>
                      <VStack align={'stretch'} h={'17rem'} spacing={'1.5rem'}>
                        <Box w={'100%'}>
                          <Text
                            color={'#485766'}
                            fontSize={'1.25rem'}
                          ...
                          >
                            {localeText(
                              LANGUAGES.MY_PAGE.ORDER.REASONS_FOR_CANCELLATION,
                            )}
                          </Text>
                        </Box>
                    ...
                    <Box minW={'8.5rem'} w={'100%'} h={'4rem'}>
                      ...
                      >
                        ...
                        >
                          {localeText(
                            LANGUAGES.MY_PAGE.ORDER.REQUEST_CANCELLATION,
                          )}
                        </Text>
                      </Button>
                    </Box>
