...
// lounge 타입
export const LOUNGE_TYPE_HOME = 0;
...
export const TIME_ZONE = 'America/New_York'; // 미국 동부 표준시 (EST/EDT)
...
// export const LIST_CONTENT_NUM = utils.isLocalTest() ? [1, 2, 3] : [10, 20, 30];
export const LIST_CONTENT_NUM = [15, 30, 50];
...
// 일반적 경우
export const LIST_PURCHASEMINIMUM = [
  '0-$5',
  '$6-$20',
  '$21-$50',
  '$51-$100',
...
// 회원가입시?
export const SYSTEM_LIST_PURCHASEMINIMUM = [
  '$0',
  '$100',
  '$300',
  '$500',
