...
const RangeDatePicker = (props) => {
  ...
  const { dateStr, start, end, isBefore = true } = props;
  ...
  return (
    <Box className="custom-range-date" w={'100%'} ref={datePickerRef}>
      <DatePicker
        ...
        open={isOpen}
        // locale={lang === COUNTRY.COUNTRY_INFO.KR.LANG ? ko : enUS}
        locale={enUS}
        dateFormat={'yyyy. MM. dd'}
        selected={startDate}
        onChange={handleOnChange}
        minDate={isBefore === false && now}
        maxDate={isBefore === true && now}
        startDate={startDate}
        endDate={endDate}
        selectsRange
